# 🏗️ Tekton Pipeline Studio
> Author declarative Kubernetes-native CI/CD build definitions. Scaffold Tekton Tasks, Pipelines, and PipelineRuns, and execute interactive DAG steps runs.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/tekton-pipeline/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/tekton-pipeline/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-tekton-pipeline.git
cd tp-tekton-pipeline
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/tekton-pipeline/) |
